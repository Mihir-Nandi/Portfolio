      ...
      <main className="container mx-auto px-4 py-8 space-y-16">
        ...
        <section id="education" className="space-y-8">
          ...
          >
            ...
            <p>
              HSC Board Exam: {userData.education.std12th.cetPercentile}
              %tile
            </p>
        ...
        <section id="courses" ref={courseRef} className="space-y-8">
          <h2 className="text-2xl font-bold border-b-2 border-gray-200 dark:border-gray-700 pb-2">
            Courses Completed
          </h2>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    {userData.extracurricular.map((activity, index) => (
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400">{activity.role}</p>
        <p className="text-gray-600 dark:text-gray-400">{activity.year}</p>
        <p>{activity.description}</p>
        
        {activity.certificate && (
          <div className="mt-4">
            <CertificateButton repoLink={activity.certificate}>
              View Certificate
            </CertificateButton>
          </div>
        )}
